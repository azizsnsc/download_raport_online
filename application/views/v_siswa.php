        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                <img class="profile-img" src="<?php echo base_url().'assets/images/'.$set['LogoSekolah'];?>?sz=120"
                    alt=""><center style="font-weight: bold; font-size: 18px;">DATA ANDA<br/></center>
                <form class="form-signin" method="post" action="<?php echo base_url('siswa/proses');?>">
                  ...
                  <?php
                    ...
                    if (empty($d)) {
                      ...
                      $dt = $sis->row_array();
                      echo '<a href="'.base_url("siswa/download/").$dt["nis"].'/'.$dt['LinkRaport'].'" class="btn btn-lg btn-primary btn-block">Download Raport</a>';
                    }
                  ?>
