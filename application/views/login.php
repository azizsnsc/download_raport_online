...
<head>
  ...
  <title>Aplikasi Pembagian Raport On-Line</title>
        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                <img class="profile-img" src="<?php echo base_url().'assets/images/'.$set['LogoSekolah'];?>?sz=120"
                    alt=""><center style="font-weight: bold; font-size: 18px;">LOGIN ADMINISTRATOR</center>
              <?php
              ...
              ?>
                ...
                <?php } ?>
                <form class="form-signin" method="post" action="<?php echo base_url('adminpanel/proses');?>">
